...
bool TEST_DIV_NN_N(){
    ...
    Test testData = {
      {"200100", "11500", "403", "11721","2010", "500", "784378783", "7483795734959837573407504735349075047305", "10", "121", "6", "100", "745", "13", "35", "35"}, // in1
      {"10", "5",  "20", "30", "10","500", "7433", "48374973948739", "5", "11", "2", "50", "15", "3", "1", "2"},  // in2
      {},              // k
      {"20010", "2300", "20", "390", "201", "1", "105526", "154703871115054505468805290", "2","11", "3", "2", "49", "4", "35", "17"}, // Ожидаемые результаты
      true,                    // is_in2
      false                     // is_k
  };
...
bool TEST_MOD_NN_N(){
  ...
  Test testData = {
    {"11500", "403", "11721","201", "784378783", "7483795734959837573407504735349075047305"}, // in1
    {"5", "20", "30", "10", "7433", "48374973948739"},  // in2
    {},              // k
    {"0", "3", "21", "1", "4025", "25373043017995"}, // Ожидаемые результаты
    true,                    // is_in2
    false                     // is_k
  };
...
bool TEST_LCM_NN_N(){
    ...
    Test testData = {
    {"11500", "403", "11721", "201", "7"}, // in1
    {"5", "20", "30", "10", "5"},  // in2
    {},              // k
    {"11500", "8060", "117210", "2010", "35"}, // Ожидаемые результаты
    true,                    // is_in2
    false                     // is_k
  };
